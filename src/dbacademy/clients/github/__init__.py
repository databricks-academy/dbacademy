__all__ = ["from_args", "databricks_academy"]
...
class GitHubClient(ApiClient):
    ...
    def __init__(self, *, org_name: str):
        ...
        super().__init__(endpoint="https://api.github.com", token=None)
...
def from_args(org_name: str):
    return GitHubClient(org_name=org_name)


def databricks_academy() -> GitHubClient:
    return GitHubClient(org_name="databricks-academy")
