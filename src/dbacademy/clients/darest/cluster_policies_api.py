__all__ = ["ClustersPolicyApi"]

from typing import Optional, Dict, Any
from dbacademy.clients.rest.common import ApiContainer, ApiClient


class ClustersPolicyApi(ApiContainer):
    def __init__(self, client: ApiClient):
        from dbacademy.common import validate

        self.__client = validate(client=client).required.as_type(ApiClient)
        self.base_uri = f"{self.__client.endpoint}/api/2.0/policies/clusters"

    def get_by_id(self, policy_id):
        return self.__client.api("GET", f"{self.base_uri}/get?policy_id={policy_id}")
    ...
    def list(self):
        ...
        return self.__client.api("GET", f"{self.base_uri}/list").get("policies", [])
    ...
    def delete_by_id(self, policy_id):
        return self.__client.api("POST", f"{self.base_uri}/delete", policy_id=policy_id)
