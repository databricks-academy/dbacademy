...
class SqlWarehousesApi(ApiContainer):

    def __init__(self, client: ApiClient):
        from dbacademy.common import validate

        self.__client = validate(client=client).required.as_type(ApiClient)
        self.base_uri = f"{self.__client.endpoint}/api/2.0/sql/warehouses"

    def start(self, endpoint_id):
        return self.__client.api("POST", f"{self.base_uri}/{endpoint_id}/start")

    def stop(self, endpoint_id):
        return self.__client.api("POST", f"{self.base_uri}/{endpoint_id}/stop")

    def get_by_id(self, endpoint_id):
        return self.__client.api("GET", f"{self.base_uri}/{endpoint_id}")
    ...
    def delete_by_id(self, endpoint_id):
        self.__client.api("DELETE", f"{self.base_uri}/{endpoint_id}", _expected=(200, 404))
        return None
    ...
    def list(self):
        result = self.__client.api("GET", self.base_uri)
    ...
    def create(self,
        ...
        result = self.__client.api("POST", f"{self.base_uri}", params)
    ...
    def update(self,
        ...
        self.__client.api("POST", f"{self.base_uri}/{endpoint_id}/edit", params)
