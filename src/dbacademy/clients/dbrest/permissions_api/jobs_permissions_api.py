__all__ = ["JobsPermissionsApi"]

from dbacademy.clients.rest.common import ApiClient
from dbacademy.clients.dbrest.permissions_api.permission_crud_api import PermissionsCrudApi, What


class JobsPermissionsApi(PermissionsCrudApi):
    ...
    def __init__(self, client: ApiClient):
        ...
        super().__init__(client, "/api/2.0/preview/permissions/jobs", "job")
    ...
    def change_owner(self, job_id, owner_type: What, owner_id: str):
        ...
        return self.__client.api("PATCH", f"{self.path}/{job_id}", _data=params)
