__all__ = ["PermissionsCrudApi", "What"]
...
class PermissionsCrudApi(ApiContainer):
    valid_permissions = ()
    ...
    def get_levels(self, id_value: ItemId = None) -> PermissionLevelList:
        ...
        return self.__client.api("GET", url).get("permission_levels")

    def get(self, id_value: ItemId = None) -> ACL:
        return self.__client.api("GET", f"{self.path}/{id_value}")
    ...
    def update(self, id_value: ItemId = None, *, what: What, value: str, permission_level: PermissionLevel):
        ...
        return self.__client.api("PATCH", url, access_control_list=acl)
    ...
    def replace(self, id_value: ItemId = None, *, acl: ACL):
        if id_value is None:
            ...
            url = f"{self.path}/{id_value}"
        return self.__client.api("PUT", url, access_control_list=acl)
