...
class EventConfig:
    def __init__(self, *, event_id: Optional[int], max_participants: int, description: Optional[str]):
        ...
        assert description is None or type(description) == str, f"""The parameter "description" must be a string value or None, found {type(description)}."""
        description = None if description is None or description.strip() == "" else description
