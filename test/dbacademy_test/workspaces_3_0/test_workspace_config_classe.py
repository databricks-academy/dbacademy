...
class TestWorkspaceConfig(unittest.TestCase):
    ...
    def test_create_workspace_config_dbc_urls(self):
        ...
        workspace_config = WorkspaceConfig(max_users=250, courses=self.courses, datasets=self.datasets, default_node_type_id="i3.xlarge", default_dbr="11.3.x-scala2.12", dbc_urls=None, credentials_name="default", storage_configuration="us-west-2", username_pattern="class+{student_number}@databricks.com", workspace_name_pattern="classroom-{event_id}-{workspace_number}")
