...
class MyTestCase(unittest.TestCase):
    ...
    def test_get_latest_commit_id(self):
        ...
        commit_id = github.databricks_academy().repo("dbacademy").commits.get_latest_commit_id(branch_name="main")
    ...
    def test_list_all_tags(self):
        ...
        all_tags = github.databricks_academy().repo("dbacademy").list_all_tags()
